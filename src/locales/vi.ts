...
const locale: Record<string, string> = {
  ...
  'editor.fontFamily.tooltip': 'Họ phông chữ',
  ...
  'editor.table.mergeCells': 'Gộp các ô',
  'editor.table.splitCells': 'Tách các ô',
  'editor.table.delete': 'Xóa bảng',
  'editor.table.setCellsBgColor': 'Đặt màu nền cho ô',
  'editor.table.insertColumnLeft': 'Chèn cột bên trái',
  'editor.table.insertColumnRight': 'Chèn cột bên phải',
  'editor.table.deleteColumn': 'Xóa cột',
