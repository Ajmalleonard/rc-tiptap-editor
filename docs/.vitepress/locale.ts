...
const docsLink = 'https://rc-tiptap-editor.vercel.app';
const githubRepo = 'hunghg255/rc-tiptap-editor';
const githubLink: 'https://github.com/hunghg255/rc-tiptap-editor' = `https://github.com/${githubRepo}`;
