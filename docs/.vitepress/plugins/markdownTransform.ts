...
export function MarkdownTransform(): Plugin {
  return {
    name: 'rc-tiptap-editor-transform',
    enforce: 'pre',
...
const GITHUB_BLOB_URL = 'https://github.com/hunghg255/rc-tiptap-editor/blob/main/packages/core/src';
const GITHUB_BLOB_DOCS_URL =
  'https://github.com/hunghg255/rc-tiptap-editor/blob/main/docs/reference';
